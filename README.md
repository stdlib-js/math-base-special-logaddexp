...
```javascript
logaddexp = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-logaddexp@v0.2.4-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-logaddexp@v0.2.4-umd/browser.js"></script>
```
